...
test('calculateVacancyRate uses client vacancy when it is below market quarter profile', () => {
...
test('calculateVacancyRate uses market quarter profile when client vacancy is above market', () => {
    const result = calculateVacancyRate({
        questionnaire: {
            valuationDate: '2025-01-01',
            calculationMethod: 'actual_market',
