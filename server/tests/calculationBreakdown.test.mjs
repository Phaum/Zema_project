...
test('buildCalculationBreakdown hides correction lines for quarter-based cap, vacancy and opex profiles', () => {
    const breakdown = buildCalculationBreakdown(
        ...
        {},
        {
            ...
            vacancyRate: 0.09,
            vacancyRatePercent: 9,
            vacancyRateSource: 'quarter_profile',
            vacancyRateSourceLabel: 'Квартальный рыночный профиль незаполняемости (1 кв. 2025)',
            baseVacancyRate: 0.09,
            vacancyAdjustments: [],
            pgi: 18000000,
            egi: 16380000,
            ...
            capitalizationAdjustments: [],
            valueTotal: 129402000,
            landShare: 1000000,
            finalValue: 128402000,
            pricePerM2: 128402,
