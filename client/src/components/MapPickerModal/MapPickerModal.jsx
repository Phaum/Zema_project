            ...
            <div style={{ marginBottom: 12 }}>
                <Space direction="vertical" style={{ width: '100%' }} size={12}>
                    <Alert
                        type="info"
                        showIcon
                        message="Кликните по карте, чтобы выбрать местоположение объекта. Карта используется для корректировки координат; адрес в анкете не будет перезаписан, если он уже задан."
                    />
