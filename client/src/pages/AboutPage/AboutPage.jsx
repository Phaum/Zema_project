                        ...
                        <Col xs={24} lg={14}>
                            <Card className="about-card about-card-large">
                                ...
                                <Paragraph className="about-paragraph">
                                    ...
                                    Главное назначение платформы «ЗЕМА» — предоставить собственнику предварительное заключение о величине рыночной стоимости объекта недвижимости
                                    и её вероятном диапазоне. Мы не готовим полноценный отчёт об оценке, 
                                    а даём вам быструю и объективную аналитику, основанную на реальных рыночных данных.
                                </Paragraph>

                                <Paragraph className="about-paragraph">
                                   Такой подход позволяет уже на первом этапе понять, 
                                   насколько кадастровая стоимость вашего объекта отличается от рыночной 
                                   и есть ли экономический смысл инициировать процедуру оспаривания. 
                                   Вы получаете чёткое представление о перспективах и можете принять взвешенное решение, 
                                   не тратя время и ресурсы на углублённый анализ без необходимости.
                                </Paragraph>
                                ...
                                <Paragraph className="about-paragraph">
                                   Экономите время: предварительное заключение формируется в кратчайшие сроки.
                                    Получаете ясность: сразу видите потенциал для снижения налоговой нагрузки.
                                    Принимаете обоснованные решения: понимаете, стоит ли двигаться дальше и оспаривать кадастровую стоимость.
