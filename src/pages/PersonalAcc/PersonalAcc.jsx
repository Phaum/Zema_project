        ...
        <div className="sidebar sharp-card">
          <div className="user-info">
            <Avatar 
              ...
              src="/zema-project/zema-platform/src/images/zema_background.jpg"
            />
            <Title level={4} className="user-name">Иванов Иван</Title>
            <Text className="user-email">ivanov@example.com</Text>
          </div>
